...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[vw_ROShopsClosedDate]
AS
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_ROShopsClosedDate', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_ROShopsClosedDate', NULL, NULL
GO
