...
GO
/*vw_NoTax_Sublets*/
CREATE VIEW [dbo].[vw_NoTax_Sublets]
AS
SELECT        dbo.RO_Repair_Orders.number AS RONumber, dbo.RO_Repair_Orders.id AS P_results_id, dbo.Shops.identifier AS shop_id, CONVERT(varchar(10), DATEADD(hour, - 7, dbo.RO_Repair_Orders.closed_at), 120) AS ClosedDate, 
                         CASE WHEN dbo.RO_Repair_Orders.taxable = 1 THEN CASE WHEN dbo.RO_Sublets.taxable = 1 THEN 0 ELSE dbo.RO_Sublets.price_cents / 100.0 END ELSE dbo.RO_Sublets.price_cents / 100.0 END AS NonTaxed
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Finds Sublets not taxed', 'SCHEMA', N'dbo', 'VIEW', N'vw_NoTax_Sublets', NULL, NULL
GO
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Or = 1350
         Or = 1350
 ', 'SCHEMA', N'dbo', 'VIEW', N'vw_NoTax_Sublets', NULL, NULL
GO
...
DECLARE @xp int
SELECT @xp=2
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_NoTax_Sublets', NULL, NULL
GO
