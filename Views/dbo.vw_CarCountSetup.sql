...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[vw_CarCountSetup]
AS
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_CarCountSetup', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_CarCountSetup', NULL, NULL
GO
