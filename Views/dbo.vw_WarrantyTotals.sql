...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[vw_WarrantyTotals]
AS
SELECT        dbo.Payments.repair_order_id AS P_results_id, SUM(dbo.Payments.amount_cents * 1.0 / 100) * - 1 AS Warranty
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_WarrantyTotals', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_WarrantyTotals', NULL, NULL
GO
