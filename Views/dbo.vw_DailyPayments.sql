...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[vw_DailyPayments]
AS
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "vw_PaymentsDetails"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 208
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_DailyPayments', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_DailyPayments', NULL, NULL
GO
