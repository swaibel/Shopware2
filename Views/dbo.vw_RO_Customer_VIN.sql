...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[vw_RO_Customer_VIN]
AS
SELECT        dbo.RO_Repair_Orders.number AS RONumber, CONVERT(varchar(10), DATEADD(hour, - 7, dbo.RO_Repair_Orders.closed_at), 120) AS ClosedDate, dbo.Shops.identifier AS shop_id, dbo.Vehicles.vin, dbo.Customers.first_name, 
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_RO_Customer_VIN', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_RO_Customer_VIN', NULL, NULL
GO
