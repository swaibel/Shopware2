...
GO
/*vw_NoTax_Labors*/
CREATE VIEW [dbo].[vw_NoTax_Labors]
AS
SELECT        dbo.RO_Repair_Orders.number AS RONumber, dbo.RO_Repair_Orders.id AS P_results_id, dbo.Shops.identifier AS shop_id, CONVERT(varchar(10), DATEADD(hour, - 7, dbo.RO_Repair_Orders.closed_at), 120) AS ClosedDate, 
                         CASE WHEN dbo.RO_Repair_Orders.taxable = 1 THEN CASE WHEN dbo.RO_Labors.taxable = 1 THEN 0 ELSE (dbo.RO_Labors.hours * dbo.RO_Services.labor_rate_cents / 100) 
                         END ELSE (dbo.RO_Labors.hours * dbo.RO_Services.labor_rate_cents / 100) END AS NonTaxed
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Finds Labor not taxed', 'SCHEMA', N'dbo', 'VIEW', N'vw_NoTax_Labors', NULL, NULL
GO
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         SortType = 1350
         SortOrder = 1410
         GroupBy', 'SCHEMA', N'dbo', 'VIEW', N'vw_NoTax_Labors', NULL, NULL
GO
EXEC sp_addextendedproperty N'MS_DiagramPane2', N' = 1350
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_NoTax_Labors', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=2
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_NoTax_Labors', NULL, NULL
GO
